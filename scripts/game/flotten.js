...
function refreshFormData() {
	...
	if (dataFlyCargoSpace >= 0) {
		$("#consumption").html("<font color=\"PKLandGreen\">" + NumberGetHumanReadable(dataFlyConsumption) + "</font>");
		$("#storage").html("<font color=\"PKLandGreen\">" + NumberGetHumanReadable(dataFlyCargoSpace) + "</font>");
	} else {
...
function calculateTransportCapacity() {
	...
	if (transportCapacity < 0) {
		...
		document.getElementById("remainingresources").innerHTML = "<font color=PKLandGreen>" + NumberGetHumanReadable(transportCapacity) + "</font>";
	}
