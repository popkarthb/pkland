...
<tr>
	...
	<tr>
		<td>{$se_energy_speed_produce}</td>
		<td><input name="energy_speed_produce" value="{$energy_speed_produce}" type="text"></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
		<td>{$se_energy_speed_consume}</td>
		<td><input name="energy_speed_consume" value="{$energy_speed_consume}" type="text"></td>
		<td>&nbsp;</td>
	</tr>
	<tr>
	<td>{$se_forum_link}</td>
