...
$LNG['ov_principal_planet_cant_abanone']	= '您不能遗弃主基地！';
...
$LNG['ov_security_confirm']					= '您确定要摧毁掉 %s 这个基地？';
$LNG['ov_password']							= '密码';
$LNG['ov_delete_planet']					= '遗弃基地';
...
$LNG['gl_no_deuterium_to_view_galaxy']		= '您的石油储量不足，因此暂时无法探索';//You dont have enough deuterium to view the galaxy
$LNG['gl_legend']							= '描述';
$LNG['gl_strong_player']					= '高战';
$LNG['gl_week_player']						= '低战';
...
$LNG['gl_out_space']						= '探索未知地区';
$LNG['gl_avaible_missiles']					= '导弹';
$LNG['gl_fleets']							= '部队数量';
$LNG['gl_avaible_grecyclers']				= '大型采集器';
$LNG['gl_avaible_recyclers']				= '回收采集器';
$LNG['gl_avaible_spyprobes']				= '侦察兵';
...
$LNG['fl_send_back']						= '返航';
$LNG['fl_acs']								= '集结';
$LNG['fl_no_more_slots']					= '没有更多空闲位置';
$LNG['fl_speed_title']						= '速度: ';
$LNG['fl_continue']							= '继续';
$LNG['fl_no_ships']							= '没有空闲的舰船';
$LNG['fl_remove_all_ships']					= '全部清除';
$LNG['fl_select_all_ships']					= '选择全部';
$LNG['fl_fleets']							= '部队';
...
$LNG['fl_order']							= '命令';
$LNG['fl_new_mission_title']				= '新任务：';
$LNG['fl_ship_type']						= '兵种';
$LNG['fl_ship_available']					= '现有数量';
...
$LNG['fl_multi_alarm']						= '您的账号与对方账号IP地址一致!';
$LNG['fl_empty_target']						= 'Without mission available (the planet exist?)';
$LNG['fl_expedition_alert_message']		    = '注意！探险是极其危险的任务！<br>
<br>
您有1/10的概率失去您所有探险的部队！<br>
您有1/10的概率获得资源，数量与部队总价有关！<br>
您有1/10的概率找到迷失的己方部队！<br>
您有1/10的概率遇到敌方部队！<br>
您有3/10的概率获得钻石，数量与部队总价有关！<br>
您有3/10的概率什么也没遇到！';
...
$LNG['bd_working']							= '忙碌中';
$LNG['bd_build']							= '建造';
$LNG['bd_build_next_level']					= '升级至Level ';//建筑升级，砍掉
$LNG['bd_research']							= '研究';
$LNG['bd_tech']								= '研究';
$LNG['bd_tech_next_level']					= '升级至Level ';
...
$LNG['bd_shipyard_required']				= '您应该先<a href="game.php?page=buildings"><font color=red>建立</font></a>一个造兵厂';
...
$LNG['bd_need_engine']                      = '需要多消耗<font color="green">%s</font>点%s';
$LNG['bd_more_engine']                      = '增加<font color="green">%s</font>点发电量';//<input type="hidden">%s</input>
$LNG['bd_jump_gate_action']                 = 'Jump';
$LNG['bd_cancel_warning'] = '从以上选择框选择您需要加速或取消的单位后点击加速或取消。<br>注意: 如果您取消，您只会收回花费资源的60%。<br>';
$LNG['bd_cancel_send']                      = '取消';
$LNG['bd_destroy_time']                     = 'Duration';
$LNG['bd_max_ships']                        = 'max';
$LNG['bd_max_ships_long']                   = '最大可建造单位数：';
...
$LNG['tr_cost_dm_trader']					= '每一笔资源出售需要消耗 %s %s!';
$LNG['tr_not_enought']						= "没有足够的%s。";
$LNG['tr_exchange_done']					= '交易成功';
$LNG['tr_exchange_error']					= '交易失败';
$LNG['tr_call_trader']						= '资源出售';
$LNG['tr_call_trader_who_buys']				= '选择你需要出售的资源';
$LNG['tr_call_trader_submit']				= '资源出售';
$LNG['tr_exchange_quota']					= '当前资源汇率';
$LNG['tr_sell']								= '出售资源';
$LNG['tr_resource']							= '资源';
$LNG['tr_amount']							= '数量';
$LNG['tr_quota_exchange']					= '汇率';
$LNG['tr_exchange']							= '出售资源';

$LNG['tp_wrong_planet_type']			    = '传送失败，无法传送营地或废墟。';
$LNG['tp_target_exist']					    = '传送失败，目标已有基地';
$LNG['tp_diamonds_not_enough']			    = '传送失败，钻石余额不足。';
$LNG['tp_success']			                = '传送成功';
$LNG['tp_wrong_coordinate']			        = '传送失败，超出地图范围，当前地图范围';
$LNG['tp_data_error']			            = '非法输入';
...
$LNG['in_jump_gate_done'] = '跳跃门已使用，您可以在以下时间再次使用它：';
$LNG['in_jump_gate_error_data'] = '错误，跳跃坐标不正确！';
$LNG['in_jump_gate_not_ready_target'] = '目标月球上的门尚未准备好，将在以下时间准备好：';
$LNG['in_jump_gate_doesnt_have_one'] = '您没有保存另一个门以进行跳跃！';
...
$LNG['in_name'] = '名称';
$LNG['in_struct_pt'] = '生命值';
$LNG['in_shield_pt'] = '防御';
$LNG['in_attack_pt'] = '攻击';
$LNG['in_capacity'] = '货物容量';
$LNG['in_units'] = '单位';
$LNG['in_base_speed'] = '基础速度';
$LNG['in_consumption'] = '燃料消耗';
$LNG['in_jump_gate_start_moon'] = '月球跳跃';
$LNG['in_jump_gate_finish_moon'] = '目标月球跳跃';
$LNG['in_jump_gate_select_ships'] = '使用跳跃门：舰队数量';
$LNG['in_jump_gate_wait_time'] = '下一次跳跃可能在：';
...
$LNG['sh_search_in_the_universe']			= '基地搜索';
$LNG['sh_player_name']						= '玩家名称';
$LNG['sh_planet_name']						= '基地名称';
