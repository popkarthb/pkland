...
$LNG['sys_colo_notech'] 					= '我们未学习探险研究，无法展开新的分基地。';
...
$LNG['sys_expe_attack_1_1_1'] 				= '一群入侵者试图强占我们的探险舰队。';
$LNG['sys_expe_attack_1_1_2'] 				= '一群入侵者袭击了我们的舰队';
$LNG['sys_expe_attack_1_1_3'] 				= '我们遭到入侵者的袭击。';
$LNG['sys_expe_attack_1_1_4'] 				= '我们与一直数量上超过我们的入侵者发生了正面冲突。';
$LNG['sys_expe_attack_1_1_5'] 				= '舰队遭到入侵者的袭击，他们试图努力保护自己。';
...
$LNG['sys_mess_destruc_report']  		  	= '报告：营地已被摧毁！';
...
$LNG['sys_destruc_lune']          		 	= '营地被摧毁的概率为： %d%% ';
$LNG['sys_destruc_rip']          			= '部队自毁的概率为： %d%%';
$LNG['sys_destruc_stop']      			 	= '防御方成功阻止了摧毁营地计划。';
$LNG['sys_destruc_mess1']       		   	= '龙夫人向基地发射了威力巨大的能量炮。';
$LNG['sys_destruc_echec']       		   	= '地震撼动了整个大陆。但是似乎出了点问题，龙夫人瓦解成了数千个碎片，冲击波及了整个部队。';
$LNG['sys_destruc_reussi']      		   	= '龙夫人发射的光束将基地撕裂成无数碎片。<br>营地被完全摧毁掉了。';
$LNG['sys_destruc_null']        		   	= '龙夫人无法发送能力炮。<br> 营地没有被摧毁。';
...
$LNG['type_mission_4']  					= '静止';
$LNG['type_mission_5']  					= '待命';
...
$LNG['type_planet_2']  					= '基地废墟';
$LNG['type_planet_3']  					= '基地营地';
