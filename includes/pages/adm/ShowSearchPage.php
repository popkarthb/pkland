	...
	if ($CountQuery['total'] > 0)
	{
		...
		while ($WhileResult	= $GLOBALS['DATABASE']->fetch_num($FinalQuery))
		{
			...
			if ($Table == "users"){				
				...
				(($WhileResult[7] == '1')	? $WhileResult[7] = "<font color=#0F9C0C>".$LNG['one_is_no_1']."</font>" : $WhileResult[7] = $LNG['one_is_no_0']);
				(($WhileResult[8] == '1')	? $WhileResult[8] = "<font color=#0F9C0C>".$LNG['one_is_no_1']."</font>" : $WhileResult[8] = $LNG['one_is_no_0']);
			}
			...
			if ($Table == "planets p") {
				...
				$WhileResult[7]	= $WhileResult[7] > 0 ? "<font color=#0F9C0C>".$LNG['one_is_no_1']."</font>" : $LNG['one_is_no_0'];
			}
		...
		$Search['LIST']	.= "<tr><td colspan=\"20\">".$LNG['se_input_hay']."<font color=#0F9C0C>".$CountQuery['total']."</font>".$SName."</td></tr>";
		$Search['LIST']	.= "</table>";
