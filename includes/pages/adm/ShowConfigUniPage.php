...
function ShowConfigUniPage()
{
	...
	if (!empty($_POST))
	{
		$config_before = array(
			...
			'energy_speed_produce'   => $config->energy_speed_produce,
			'energy_speed_consume'   => $config->energy_speed_consume,
		);
		...
		$energy_speed_produce = HTTP::_GP('energy_speed_produce', 1);
		$energy_speed_consume = HTTP::_GP('energy_speed_consume', 1);
		...
		$config_after = array(
			...
			'energy_speed_produce'	=> $energy_speed_produce,
			'energy_speed_consume'	=> $energy_speed_consume,
        );
	...
	$template->assign_vars(array(
		...
		'se_energy_speed_produce'				=> $LNG['se_energy_speed_produce'],
		'se_energy_speed_consume'				=> $LNG['se_energy_speed_consume'],
