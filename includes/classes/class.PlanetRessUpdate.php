...
class ResourceUpdate
{
	...
	public function CreateHash() {
		...
		$Hash[]	= $this->config->energy_speed_produce ; // jeff 产电
	...
	public function ReBuildCache()
	{
		...
		$this->PLANET['energy']				= round($temp[911]['plus'] * $this->config->energy_speed_produce * (1 + $this->USER['factor']['Energy']));
		$this->PLANET['energy_used']		= $temp[911]['minus'] * $this->config->energy_speed_consume;
