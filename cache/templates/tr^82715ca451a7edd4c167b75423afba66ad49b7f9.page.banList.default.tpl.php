...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_6398050cafbbf8_16449884',
...
function content_6398050cafbbf8_16449884 (Smarty_Internal_Template $_smarty_tpl) {
...
<header>
	<nav>
		<ul id="menu">
			...
			<li><a href="index.php?page=battleHall">En Buyuk Savaslar</a></li>
			<li><a href="index.php?page=banList">Banlananlar</a></li>
			<li><a href="index.php?page=disclamer">Iletisim</a></li>
		</ul>
	</nav>
	<nav>
			...
			<td class="box-out-content-center">
				<table class="box-inner">
					<tr class="box-inner-header">
						...
						<td class="box-inner-header-center"><h1>Banlananlar</h1></td>
...
<table>
	<tr>
		<th colspan="5">Cezali oyuncularin listesi</th>
	</tr>
