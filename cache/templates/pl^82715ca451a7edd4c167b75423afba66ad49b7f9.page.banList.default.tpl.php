...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_6398050b23ae29_38435715',
...
function content_6398050b23ae29_38435715 (Smarty_Internal_Template $_smarty_tpl) {
...
<header>
	<nav>
		<ul id="menu">
			...
			<li><a href="index.php?page=battleHall">Hala sław</a></li>
			<li><a href="index.php?page=banList">Pręgierz</a></li>
			<li><a href="index.php?page=disclamer">Kontakt</a></li>
		</ul>
	</nav>
	<nav>
			...
			<td class="box-out-content-center">
				<table class="box-inner">
					<tr class="box-inner-header">
						...
						<td class="box-inner-header-center"><h1>Pręgierz</h1></td>
...
<table>
	<tr>
		<th colspan="5">Lista zbanowanych graczy</th>
	</tr>
