...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_63982fd3ea0324_60891976',
...
function content_63982fd3ea0324_60891976 (Smarty_Internal_Template $_smarty_tpl) {
			...
			<td class="box-out-content-center">
				<table class="box-inner">
					<tr class="box-inner-header">
						...
						<td class="box-inner-header-center"><h1>注册</h1></td>
...
" name="referralID">
	...
	<div class="rowForm">
		...
		<input type="text" class="input" name="username" id="username" maxlenght="32">
				<span class="inputDesc">用户名至少3个字符，最多25个字符，可以由数字，字母，下划线以及空格构成</span>
	</div>
	<div class="rowForm">
		<label for="password">密码</label>
		<input type="password" class="input" name="password" id="password">
				<span class="inputDesc">密码至少要8个字符</span>
	</div>
	<div class="rowForm">
		<label for="passwordReplay">重复密码</label>
		<input type="password" class="input" name="passwordReplay" id="passwordReplay">
				<span class="inputDesc">请输入相同的密码</span>
	</div>
	<div class="rowForm">
		<label for="email">E-Mail</label>
		<input type="email" class="input" name="email" id="email">
				<span class="inputDesc">请输入你的E-Mail地址</span>
	</div>
	<div class="rowForm">
		<label for="emailReplay">重复E-Mail</label>
		<input type="email" class="input" name="emailReplay" id="emailReplay">
				<span class="inputDesc">请输入相同的E-Mail地址！</span>
	</div>
	<?php if (count($_smarty_tpl->tpl_vars['languages']->value) > 1) {?>
	<div class="rowForm">
...
"></div>
	...
	<div class="rowForm">
		<input type="submit" class="submitButton" value="立即注册！">
	</div>
</form>
</td>
