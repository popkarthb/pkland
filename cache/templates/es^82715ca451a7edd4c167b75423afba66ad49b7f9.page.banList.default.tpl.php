...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_6398050d915fc1_63240316',
...
function content_6398050d915fc1_63240316 (Smarty_Internal_Template $_smarty_tpl) {
...
<header>
	<nav>
		<ul id="menu">
			...
			<li><a href="index.php?page=board" target="board">Foro</a></li>
			<li><a href="index.php?page=news">Noticias</a></li>
			<li><a href="index.php?page=rules">Reglas</a></li>
			<li><a href="index.php?page=battleHall">Salón de la Fama</a></li>
			<li><a href="index.php?page=banList">Baneados</a></li>
			<li><a href="index.php?page=disclamer">Contactar</a></li>
		</ul>
	</nav>
	<nav>
			...
			<td class="box-out-content-center">
				<table class="box-inner">
					<tr class="box-inner-header">
						...
						<td class="box-inner-header-center"><h1>Baneados</h1></td>
...
<table>
	<tr>
		<th colspan="5">Lista de jugadores sancionados</th>
	</tr>
